...
- **Casa ES Consumo Casa**: box separato con il consumo totale istantaneo.
- **Casa ES Consumo Dispositivo**: box riutilizzabile da configurare per ogni elettrodomestico.
...
- Consumo Casa: importa `packages/casa-es-consumo-casa-1.0.0.zip` da **Store → Comunità → JAVA → Carica ZIP**.
- Consumo Dispositivo: importa `packages/casa-es-consumo-dispositivo-1.0.0.zip` da **Store → Comunità → JAVA → Carica ZIP**.
